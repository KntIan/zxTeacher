<template>
	<div :class="['TUI-profile', !isPC && 'TUI-profile-h5']">
		...
		<div v-if="displayType !== 'profile' && (!isPC || showSetting)" ref="settingDomRef"
			:class="['TUI-profile-setting', !isPC && 'TUI-profile-h5-setting']">
			<div v-for="(item, key) in settingList" :key="key" :class="[
          ...
          " :show="item.showChildren" @onClose="bottomPopupOnClose(item)">
					<div v-for="child in item.children" :class="[
