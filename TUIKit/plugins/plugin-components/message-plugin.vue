<template>
	<MessagePluginLayout :message="props.message" :showStyle="pluginMessageType.showStyle"
		...
		<template #messageTip>
			<MessageCallGroup :message="props.message" :signalingInfo="messageSignalingInfo"
				:customContent="messageCustomContent" :blinkMessageIDList="props.blinkMessageIDList" />
		</template>
		<template #messageBubble>
			<MessageCallC2C v-if="pluginMessageType.pluginType === 'call'" :message="props.message"
				:signalingInfo="messageSignalingInfo" :customContent="messageCustomContent" />
			<MessageCustomerService v-if="pluginMessageType.pluginType === 'customer'" :message="props.message" />
			<MessageRoom v-if="pluginMessageType.pluginType === 'room'" :message="props.message" />
		</template>
	</MessagePluginLayout>
</template>
