      ...
      `container-${props.searchType}`,
        ...
        !isPC && 'tui-search-container-h5-main',
			...
			<div class="tui-search-tabs">
				<div v-for="(tabItem, tabKey) in searchTypeList" :key="tabKey" :class="[
			...
			<div v-if="isTimeTabsShow" class="tui-search-time">
				<div v-for="(tabItem, tabKey) in searchMessageTimeList" :key="tabKey" :class="[
            ...
            currentSearchMessageTime.key === tabItem.key && 'tui-search-time-item-selected',
					...
					<div v-if="tabItem.key === 'all'" class="tui-search-time-item-picker">
						<div v-if="!isDatePickerShow" class="tui-search-time-item-all"
                ...
                TUITranslateService.t(`TUISearch.选择时间`) +
                  ...
                  TUITranslateService.t(`TUISearch.全部`)
						...
						<div @click.stop>
							<DatePicker v-if="isDatePickerShow" type="range"
								:rangeTableType="datePickerRangeDisplayType" @pick="pickTimePeriod" />
						</div>
						<div v-if="isDatePickerShow" class="tui-search-time-item-close" @click="clearTimePicker">
