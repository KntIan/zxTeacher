<template>
  ...
  >
    ...
    >
      ...
      >
        <SearchInput class="search-input" :searchType="searchType" />
        <SearchMore
      ...
      >
        <template #result>
          <SearchResult class="search-result" :searchType="searchType" />
        </template>
      </SearchContainer>
    </div>
    <div
    ...
    >
      ...
      >
        <template #input>
          <SearchInput :searchType="searchType ? searchType : 'conversation'" />
        </template>
        <template #result>
          <SearchResult
            class="search-result"
...
import { ref, onMounted, computed, withDefaults, onUnmounted } from 'vue'
