      ...
      isHovering && 'hover-' + displayType,
		...
		<div v-if="displayType === 'info' || displayType === 'bubble'" :class="[displayType]">
			...
			<div :class="[displayType + '-main']">
				...
				<div :class="[displayType + '-main-content']">
					<MessageAbstractText v-if="displayType === 'info' || listItem.type === TYPES.MSG_TEXT"
						:content="contentForShow" :highlightType="displayType === 'info' ? 'font' : 'background'"
						:displayType="displayType" />
					<MessageAbstractFile v-else-if="listItem.type === TYPES.MSG_FILE" :contentText="contentForShow"
						:messageContent="listItemContent" :displayType="displayType" />
					...
					<MessageAbstractCustom v-else-if="listItem.type === TYPES.MSG_CUSTOM" :contentText="contentForShow"
						:message="listItem" :messageContent="listItemContent" />
					<div v-else>
			...
			<div :class="displayType + '-right'">
				...
				<div v-if="displayType === 'bubble' && isHovering" :class="displayType + '-right-to'"
		...
		<div v-else-if="displayType === 'file'" :class="[displayType]">
			<div :class="[displayType + '-header']">
				...
				<div v-if="isHovering" :class="displayType + '-header-to'" @click.stop="navigateToChatPosition">
					{{ TUITranslateService.t("TUISearch.定位到聊天位置") }}
				</div>
			...
			<div :class="[displayType + '-main-content']">
				<MessageAbstractFile :contentText="contentForShow" :messageContent="listItemContent"
					displayType="bubble" />
			</div>
		</div>
