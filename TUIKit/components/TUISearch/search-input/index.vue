	...
	<div :class="[
      ...
      props.searchType === 'global'
		...
		<div :class="['tui-search-input', !isPC && 'tui-search-input-h5']">
			...
			<input v-model="searchValueModel" class="tui-search-input-main" type="text" :placeholder="props.placeholder"
				:focus="false" enterkeyhint="search" @blur="onBlur" @keyup.enter="search" @confirm="search"
		...
		<div v-if="!isPC && searchingStatus && props.searchType === 'global'" :class="[
