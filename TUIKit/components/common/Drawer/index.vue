<template>
	<Overlay ref="overlayDomInstanceRef" :visible="props.visible" :useMask="props.useMask"
		:maskColor="props.overlayColor" :isFullScreen="props.isFullScreen" @onOverlayClick="onOverlayClick">
		<div v-if="isDrawerShow" ref="drawerDomRef" :class="{
        'drawer': true,
