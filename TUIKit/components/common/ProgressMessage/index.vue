<template>
  <div class="progress-message">
    <slot />
    <div v-if="props.messageItem.status === 'unSend' && props.messageItem.progress < 1" class="progress-container">
      <progress v-if="!isUniFrameWork" class="progress" :value="props.messageItem.progress" max="1" />
      <progress v-else activeColor="#006EFF" class="progress-common" :percent="Math.round(props.messageItem.progress*100)" />
    </div>
  </div>
</template>
