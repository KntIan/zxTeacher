<template>
	<div v-if="isOverlayShow" ref="overlayDomRef" class="overlay-container" :style="{
      position: props.isFullScreen ? 'fixed' : 'absolute',
      zIndex: props.zIndex,
    }">
		<div v-if="props.useMask" :class="{
        'overlay-mask': true,
        'fade-in': props.visible,
      }" :style="{
        backgroundColor: props.maskColor,
      }" @click="onOverlayClick" @touchstart.prevent.stop="onOverlayClick" />
		<div :class="{
