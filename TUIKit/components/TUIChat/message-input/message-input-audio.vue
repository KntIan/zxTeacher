<template>
	<div :class="{
      ...
      'message-input-audio-open': isAudioTouchBarShow,
		...
		<Icon class="audio-message-icon" :file="audioIcon" :size="'23px'" :hotAreaSize="'3px'" @onClick="switchAudio" />
		<view v-if="props.isEnableAudio" class="audio-input-touch-bar" @touchstart="handleTouchStart"
