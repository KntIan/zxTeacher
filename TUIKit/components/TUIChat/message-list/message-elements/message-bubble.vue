<template>
	<div :class="containerClassNameList">
		...
		<RadioSelect v-if="props.isMultipleSelectMode" class="multiple-select-radio" :isSelected="isMultipleSelected"
        ...
        'control-reverse': message.flow === 'out'
			...
			<div class="message-bubble-content">
				<div class="message-bubble-main-content" :class="[message.flow === 'in' ? '' : 'reverse']">
					<Avatar useSkeletonAnimation :url="message.avatar || ''" :style="{flex: '0 0 auto'}" />
					<main class="message-body" @click.stop>
						<div v-if="message.flow === 'in' && message.conversationType === 'GROUP'"
                  ...
                  !isNoPadding && isBlink ? 'blink-content' : '',
                    ...
                    " :class="['message-risk-replace', !isPC && 'message-risk-replace-h5']" :src="riskImageReplaceUrl">
							...
							<Icon
								...
								class="message-label loading-circle" :file="loadingIcon" :width="'15px'"
								:height="'15px'" />
							<!-- Read & Unread -->
