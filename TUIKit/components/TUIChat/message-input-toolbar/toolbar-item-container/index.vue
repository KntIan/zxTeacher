<template>
	<div ref="toolbarItemRef" :class="[
      ...
      isUniFrameWork && 'toolbar-item-container-uni',
		...
		<div v-show="showDialog" ref="dialogRef" :class="[
        ...
        isUniFrameWork && 'toolbar-item-container-uni-dialog',
			...
			<BottomPopup v-if="props.needBottomPopup && !isPC" class="toolbar-bottom-popup" :show="showDialog"
				@touchmove.stop.prevent @onClose="onPopupClose">
				<slot />
			</BottomPopup>
			<slot v-else />
		</div>
