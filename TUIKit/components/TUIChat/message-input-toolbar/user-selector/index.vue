<template>
	<Dialog :show="show" :isH5="!isPC" :isHeaderShow="false" :isFooterShow="false" :background="false"
		@update:show="toggleShow">
		<Transfer :isSearch="true" :title="title" :list="searchMemberList" :isH5="!isPC" :isRadio="false"
			@search="search" @submit="submit" @cancel="cancel" />
	</Dialog>
</template>
