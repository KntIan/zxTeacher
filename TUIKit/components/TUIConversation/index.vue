<template>
  ...
  >
    ...
    >
      <image
        style="position: absolute; left: 4%; width: 36rpx; height: 36rpx"
        src="../../assets/icon/a.png"
        alt=""
        @click="goback"
      />

      <text style="font-size: 32rpx" @click="goback">聊天</text>
    </div>
...
const updateParentWithLengthTeachers = () => {
  ...
  emits('updateConversationListLengthTeachers', length) // 触发事件并传递长度
}
onMounted(() => {
